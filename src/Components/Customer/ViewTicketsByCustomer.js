...
const ViewTicketsByCustomer = () => {
    ...
    const Bill = async () => {
        const bill_c = await axios.get(`http://localhost:8080/calculateBill/${id}`);
    ...
    const LoadTickets = async () => {
        const result = await axios.get(`http://localhost:8080/viewAllTicketsCustomer/${id}`)
    ...
    const deleteTicket = async (ticket_id) => {
        await axios.delete(`http://localhost:8080/deleteTicket/${ticket_id}`);
    };
